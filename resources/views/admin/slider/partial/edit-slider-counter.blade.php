<div id="edit-slider-counter_{{ $counter->id }}" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog-centered modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('slider-counter.update', $counter->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control custom-input" name="counter_title" value="{{ old('counter_title', $counter->counter_title) }}" required />
